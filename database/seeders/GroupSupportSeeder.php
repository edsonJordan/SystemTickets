...
class GroupSupportSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $GroupSupport->type_support = TypeSupport::all()->random()->id;
        $GroupSupport->save();

        $GroupSupport1 = new GroupSupport();
        $GroupSupport1->group = "Software";
        $GroupSupport1->type_support = TypeSupport::all()->random()->id;
        $GroupSupport1->save();

        $GroupSupport2 = new GroupSupport();
        $GroupSupport2->group = "General";
        $GroupSupport2->type_support = TypeSupport::all()->random()->id;
        $GroupSupport2->save();
    }
}
