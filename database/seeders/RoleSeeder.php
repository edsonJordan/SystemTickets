...
class RoleSeeder extends Seeder
{
 ...
 /*     $permission = Permission::create(['name' => 'admin.role.index'])->syncRoles([$role1]);
        ...
        $permission = Permission::create(['name' => 'admin.roles.edit', 'description' => 'Editar Roles'])->syncRoles([$role1 ]);
        $permission = Permission::create(['name' => 'admin.roles.destroy', 'description' => 'Eliminar Roles'])->syncRoles([$role1]); 

        $permission = Permission::create(['name' => 'admin.roles.general.create', 'description' => 'Ver listado de roles general'])->syncRoles([$role1]);
        $permission = Permission::create(['name' => 'admin.roles.general.store', 'description' => 'Crear Roles generales'])->syncRoles([$role1]);
        $permission = Permission::create(['name' => 'admin.roles.general.destroy', 'description' => 'Eliminar Roles generales'])->syncRoles([$role1]); 


        $permission = Permission::create(['name' => 'admin.ticket.groups.index', 'description' => 'Ver listado de Grupos de Soporte'])->syncRoles([$role1]);
        $permission = Permission::create(['name' => 'admin.ticket.groups.create', 'description' => 'Crear Grupos de Soporte'])->syncRoles([$role1]);
        $permission = Permission::create(['name' => 'admin.ticket.groups.edit', 'description' => 'Editar Grupos de Soporte'])->syncRoles([$role1]);
        $permission = Permission::create(['name' => 'admin.ticket.groups.destroy', 'description' => 'Eliminar Grupos de Soporte'])->syncRoles([$role1]);

        $permission = Permission::create(['name' => 'admin.ticket.areas.index', 'description' => 'Ver listado de Areas'])->syncRoles([$role1, $role2]);
        $permission = Permission::create(['name' => 'admin.ticket.areas.create', 'description' => 'Crear Areas'])->syncRoles([$role1]);
        $permission = Permission::create(['name' => 'admin.ticket.areas.edit', 'description' => 'Editar Areas'])->syncRoles([$role1]);
        $permission = Permission::create(['name' => 'admin.ticket.areas.destroy', 'description' => 'Eliminar Areas'])->syncRoles([$role1]);
        ...
        $permission = Permission::create(['name' => 'admin.ticket.users.show', 'description' => 'Ver Usuario'])->syncRoles([$role1]); 
        ...
        $permission = Permission::create(['name' => 'admin.ticket.tickets.show', 'description' => 'Ver Tickets'])->syncRoles([$role1]); 
        ...
        $permission = Permission::create(['name' => 'admin.ticket.tickets.mygroup', 'description' => 'Ver los Tickets de mi Grupo'])->syncRoles([$role1, $role2]);
        $permission = Permission::create(['name' => 'admin.ticket.tickets.myticket', 'description' => 'Ver los tickets que se me asignaron'])->syncRoles([$role1, $role2, $role3]);
        ...
        $permission = Permission::create(['name' => 'admin.ticket.userassignments.destroy', 'description' => 'Eliminar asignaciones de tickets a usuarios'])->syncRoles([$role1, $role3]);
        
        $permission = Permission::create(['name' => 'admin.ticket.assignments.index', 'description' => 'Ver listado de asignaciones de tickets a grupos de soporte'])->syncRoles([$role1, $role2]); 
